...
new has_confused_bomb[MAX_PLAYER+1]
new g_exploSpr

new cvar_distance, cvar_time_hit

new const v_model[] = "models/zpre4/v_zombibomb.mdl"
new const p_model[] = "models/zpre4/p_zombibomb.mdl"
new const w_model[] = "models/zpre4/w_zombibomb.mdl"

new const confusion_exp[] = "zpre4/zombi_bomb_exp.wav"
new const confusing[] = "zpre4/zombi_banshee_confusion_keep.wav"
new const confusion_spr[] = "sprites/zpre4/zb_confuse.spr"
...
public plugin_precache()
{
	...
	g_exploSpr = engfunc(EngFunc_PrecacheModel, "sprites/zpre4/zombiebomb.spr")
}

public plugin_natives()
{
	register_native("zp_get_user_conf", "native_get_user_conf", 1)
}
...
public native_get_user_conf(id)
{
