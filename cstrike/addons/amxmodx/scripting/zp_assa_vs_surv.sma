...
public plugin_init( )
{
	...
	register_plugin( "[ZP] Assassin vs Survivors Mode","1.0", "@bdul!" )
	
	// Register some cvars
	// Edit these according to your liking
	cvar_minplayers = register_cvar("zp_avsm_minplayers", "2")
	cvar_sniperhp =	  register_cvar("zp_avsm_survivor_hp", "1.5")
...
public plugin_precache( )
{
	...
	g_gameid = zp_register_game_mode( "Assassin vs Survivors Mode", access_flag, g_chance, 0, ZP_DM_BALANCE )
}
...
public zp_round_started( game, id )
{
	...
	if( game == g_gameid )
	{
		...
		ShowSyncHudMsg(0, g_msg_sync, "MODO Assassins vs Survivors !!!")
