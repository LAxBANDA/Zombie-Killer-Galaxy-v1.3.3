...
public plugin_init( )
{
	...
	register_plugin( "[ZP] Alien vs Snipers Mode","1.0", "@bdul!" )
...
public plugin_precache( )
{
	...
	g_gameid = zp_register_game_mode( "Alien vs Snipers Mode", access_flag, g_chance, 0, ZP_DM_BALANCE )
}
...
public zp_round_started( game, id )
{
	...
	if( game == g_gameid )
	{
		...
		ShowSyncHudMsg(0, g_msg_sync, "MODO Alien vs Snipers !!!")
