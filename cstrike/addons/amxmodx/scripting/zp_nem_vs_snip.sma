...
public plugin_init( )
{
	...
	register_plugin( "[ZP] Nemesis vs Snipers Mode","1.0", "@bdul!" )
	...
	cvar_assahp =	  register_cvar("zp_avsm_nemesis_hp", "1.0")
...
public plugin_precache( )
{
	...
	g_gameid = zp_register_game_mode( "Nemesis vs Snipers", access_flag, g_chance, 0, ZP_DM_BALANCE )
}
...
public zp_round_started( game, id )
{
	...
	if( game == g_gameid )
	{
		...
		ShowSyncHudMsg(0, g_msg_sync, "MODO Nemesis vs Snipers !!!")
