...
// Variables
new g_gameid, g_maxplayers, cvar_minplayers, cvar_ratio, cvar_deprehp, cvar_assahp, g_msg_sync
...
public plugin_init( )
{
	...
	register_plugin( "[ZP] Alien vs Depres Mode","1.0", "@bdul!" )
	...
	cvar_assahp =	  register_cvar("zp_avsm_alien_hp", "1.0")
...
public plugin_precache( )
{
	...
	g_gameid = zp_register_game_mode( "Alien vs Depredador", access_flag, g_chance, 0, ZP_DM_BALANCE )
}
...
public zp_round_started( game, id )
{
	...
	if( game == g_gameid )
	{
		...
		ShowSyncHudMsg(0, g_msg_sync, "MODO Alien vs Depredador !!!")
